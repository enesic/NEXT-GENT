...
.landing-support {
  padding: 100px 24px; /* Increased top/bottom padding */
...
.channel-card {
  ...
  align-items: center;
  gap: 20px;
  padding: 32px 48px; /* Larger padding for bigger boxes */
